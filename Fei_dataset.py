...
def GetSVHN_DataSet_Tanh(isResize=False):
    ...
    x_train_hv = x_train_hv.astype('float32') / 127.5 -1
    x_test_hv = x_test_hv.astype('float32') / 127.5 -1
...
def GetSVHN_DataSet_256(isResize=False):
    file1 = 'data/svhn_train.mat'
    file2 = 'data/svhn_test.mat'
    train_data = sio.loadmat(file1)
    test_data = sio.loadmat(file2)
